...
$string['hiddensection_select_label'] = 'Select hidden section for quiz instances';
$string['studentquiz_create_new_section'] = 'Create a new hidden section';
$string['hiddensectionhelp'] = 'Hidden Section';
$string['hiddensectionhelp_help'] = 'StudentQuiz generates Quiz instances which need to get attached to a hidden section.';
...
$string['no_myattempts'] = 'no attempts';
$string['no_mydifficulty'] = 'no difficulty';
$string['no_mylastattempt'] = 'no attempts';
$string['approved'] = '✓';
$string['not_approved'] = '✗';
