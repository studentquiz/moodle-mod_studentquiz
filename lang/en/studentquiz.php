...
$string['settings_lastcorrectanswerquantifier'] = 'Latest answer correct quantifier';
$string['settings_lastcorrectanswerquantifier_label'] = 'Points for latest correct answers';
$string['settings_lastcorrectanswerquantifier_help'] = 'Points received for answering a question correctly on last attempt';
$string['settings_lastincorrectanswerquantifier'] = 'Latest answer incorrect quantifier';
...
$string['reportrank_table_column_countquestions'] = 'Questions created';
$string['reportrank_table_column_approvedquestions'] = 'Approved questions';
$string['reportrank_table_column_summeanrates'] = 'Average rating';
...
$string['reportrank_table_column_lastcorrectanswers'] = 'Latest attempt correct';
$string['reportrank_table_column_lastincorrectanswers'] = 'Latest attempt incorrect ';
