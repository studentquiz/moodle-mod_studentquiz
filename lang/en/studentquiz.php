...
$string['filter_label_onlygood_help'] = 'Question with an average rating higher than 3';
$string['filter_label_onlynew'] = 'Unanswered';
$string['filter_label_onlynew_help'] = 'Only display questions you have never answered before';
$string['filter_label_onlydifficult'] = 'Difficult Questions';
$string['filter_label_onlydifficult_help'] = 'Question with a difficulty of more than 60%';
...
$string['filter_label_fast_filters'] = 'Fast filters';
...
$string['reportquiz_stats_all_rates_average'] = 'Overall rating average';
...
$string['reportrank_table_column_summeanrates'] = 'Points for ratings';
