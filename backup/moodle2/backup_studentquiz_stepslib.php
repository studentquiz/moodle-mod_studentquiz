    ...
    protected function define_structure() {
        ...
        if ($userinfo) {
            $attempt->set_source_table(
                'studentquiz_attempt',
                ['studentquizid' => backup::VAR_PARENTID]
            );
            ...
            $ratesql = "SELECT rate.*
                         ...
                         WHERE sq.id = :studentquizid";
            $rate->set_source_sql($ratesql, ['studentquizid' => backup::VAR_PARENTID]);
            ...
            $comment->set_source_sql($commentsql, ['studentquizid' => backup::VAR_PARENTID]);
